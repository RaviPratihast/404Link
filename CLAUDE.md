...
## [404linq] — Agency Website

```
Context:
  - Repo: 404Link (workspace path: ~/Documents/GitHub/404Link)
  - Purpose: Public-facing agency website for 404linq
  - Framework: Next.js 16 (App Router)
  - Build: Next.js built-in (Turbopack in dev)
  - Package Manager: pnpm
  - Styling: Tailwind CSS v4 (CSS-first, @theme tokens in globals.css)
  - No separate state management library — server components + Next.js cache by default

File Structure:
  src/
  ├── app/                      # Next.js App Router pages + layouts
  │   ├── layout.tsx            # Root layout — metadata, fonts, Header/Footer shell
  │   ├── page.tsx              # Home page
  ...
  ├── types/                    # Shared TypeScript types (used in 3+ files)
  └── constants/
      └── site.ts               # SITE_METADATA, NAV_ITEMS, and other app-wide constants

Design Tokens (globals.css @theme):
  --font-sans, --font-mono
  --color-background, --color-foreground, --color-foreground-muted
  --color-brand, --color-brand-accent
  --color-surface, --color-border
  --radius-sm, --radius-md, --radius-lg, --radius-xl

Constraints:
  - TypeScript strict mode + noUncheckedIndexedAccess + exactOptionalPropertyTypes
  - No tailwind.config.js — all config via @theme in globals.css
  - No client state library until a real need arises — default to server components
